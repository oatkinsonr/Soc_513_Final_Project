...
doctor_female$percent_female <- 100*doctor_female$percent_female

mm <- merge(mm, doctor_female, all.x=TRUE, all.y=FALSE)

# Save Data ---------------------------------------------------------------

#drop 2017
mm <- subset(mm, year<2017)

save(mm, file="output/analytical_data.RData")
