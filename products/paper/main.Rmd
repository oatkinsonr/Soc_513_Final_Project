...
# Introduction
  ...
  Another trend that has been on the rise in the United States is the percentage of female physicians. Today, the majority of physicians under the age of 35 are women (https://www.athenahealth.com/insight/healthcare-future-female). With the number of female physicians on the rise, I am interested in looking at the relationship between the maternal mortality ratios and the percentage of patients who see female doctors. The main question this paper seeks to answer is: Does seeing a female physician decrease a woman's chances of dying from pregnancy related causes? Because of gendered norms and behavior, women are thought to be and generally are more caring, attentive, and emotionally available compared to their male counterparts who are seen as aggressive, unwelcoming, and less communicative. This translates in a number of areas in social life, and this paper is interested in seeing if it would also transfer into the medical profession, as well. 

  There have been a number of studies conducted that look at the relationship between patient care and physician gender (https://www.washingtonpost.com/news/wonk/wp/2016/12/19/women-really-are-better-doctors-study-suggests/?utm_term=.37ed10ba316f, https://www.ncbi.nlm.nih.gov/pubmed/18397244, https://jamanetwork.com/journals/jamainternalmedicine/fullarticle/2593255). However, none of the studies have looked specifically at a physician's gender and its relationship to maternal mortality. As such, this project hopes to fill a gap in the literature and also encourage further studies that look at this specific relationship. 
...
# Results
  ...
  However, as Model 4 shows when the year and region are fitted with dummy variables the relationship between the percentage of female physicians with the maternal mortality ratio flips. The maternal mortality ratio actually decreases and the percentage of female physicians increases. However, this relationship is not statistically significant. On average, for every one percent increase in female physicians there is a 1.6 percent decrease in the maternal mortality ratio. While this does not seem that significant, as mentioned above in the data section, this data is at the census region level so any analysis or results will be somewhat crudely generalizable. 

  Although the R-squared values are significant, because this model is a fixed effects model R-squared values are meaningless because they include all of the time-constant variation making them inaccurate. 
...
```{r name, fig.cap="maternal mortality ratio by percent of female doctors", fig.align="center"}
...
```{r, fig.cap= "maternal mortality ratio by year", fig.align="center"}
...
```{r, fig.cap="percent female physicians by year", fig.align="center"}
